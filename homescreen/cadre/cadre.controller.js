//cadre.controller.js
'use strict';
// having to use homesreen.caseManager instead of homescreen.cadre for now due to issues 3/11
// having to use caseManagerController instead of cadreController for now due to issues 3/11
