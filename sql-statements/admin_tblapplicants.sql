...
--
-- Host: localhost
-- Generation Time: Apr 23, 2019 at 07:57 PM
...
CREATE TABLE `tblDeadPool` (
  ...
  `DeselectedReason` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `tblDeadPool`
--

INSERT INTO `tblDeadPool` (`applicantID`, `fName`, `mName`, `lName`, `PGender`, `AStatus`, `AGenQual`, `AEmail`, `guardianEmail`, `RejectedDate`, `RejectedReason`, `DeselectedDate`, `DeselectedReason`) VALUES
(11, 'Richard', '', 'Hansen', '', '', '', '', '', '0000-00-00 00:00:00', '', '0000-00-00 00:00:00', ''),
(12, 'John', '', 'Smith', '', '', '', '', '', '0000-00-00 00:00:00', '', '0000-00-00 00:00:00', ''),
(13, 'Ricardo', '', 'Manstenson', '', '', '', '', '', '0000-00-00 00:00:00', '', '0000-00-00 00:00:00', ''),
(14, 'Rick', '', 'Barney', '', '', '', '', '', '0000-00-00 00:00:00', '', '0000-00-00 00:00:00', '');
